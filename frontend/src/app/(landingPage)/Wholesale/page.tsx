  ...
  return (
    <div className="min-h-screen bg-white py-20 px-6 sm:px-10 max-w-4xl mx-auto" style={{ padding: "150px 20px" }}>
      ...
      <p className="mb-6 text-gray-700">
        Interested in offering CEBK Unique Bakery at your Job, office, or retail store? We offer competitive wholesale pricing
        and support to partners who share our passion for quality and sustainability.
      </p>
      <p className="mb-6 text-gray-700">
        Reach out to us at <a className="text-amber-800 underline" href="mailto: uniquebakerymaa@gmail.com">uniquebakeryma@gmail.com</a>
