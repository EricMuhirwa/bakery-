...
const Navbar = () => {
    ...
    return (
        <div className='w-full flex flex-row gap-[20px] items-center bg-white px-4 py-4 justify-between'>
            <div className='hidden md:flex flex-row items-center p-2 bg-[#E89A1c] rounded-[12px] px-4 py-3 gap-[10px]'>
            ...
            <div className='flex flex-row gap-[10px] items-center'>
                <div className='p-3 cursor-pointer rounded-full bg-[#E89A1A] '>
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
